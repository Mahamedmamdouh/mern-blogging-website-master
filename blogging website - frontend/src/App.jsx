...
import MangeBlogs from './pages/manage-blogs.page';
...
const darkThemePreference =()=> window.matchMedia('(prefers-colors-scheme:dark)').matches; 
    ...
    return (
        <ThemeContext.Provider value={{theme , setTheme}}>
            <UserContext.Provider value={{userAuth,setUserAuth}}>
             ...
             <Route path='blogs' element={<MangeBlogs/>}></Route>
