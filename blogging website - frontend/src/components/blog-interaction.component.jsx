...
const BlogInteraction=()=>{
      ...
      let {blog,blog:{_id,title,blog_id,activity,activity:{total_likes,total_comments},author:{
            personal_info:{username:author_username}}},setBlog,isLikedByUser,setLikedByUser,setCommentsWrapper} =useContext(BlogContext);
           ...
           useEffect(()=>{
            ...
            const handleLike=()=>{
                  if(access_token){
                        ...
                        toast.error('pleas login ti like this blog')
