...
const CommentsField=({action,index=undefined,replyingTo=undefined,setReplying})=>{
      ...
      let {blog,blog:{_id,author:{_id:blog_author},comments,comments:{results:commentsArr},activity,activity:
          {total_comments,total_parent_comments}},setBlog,setTotalParentCommentsLoaded} =
