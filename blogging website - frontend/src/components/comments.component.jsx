...
const CommentsContainer = () => {
  ...
  const loadMoreComments = async () => {
    setIsLoading(false); 
    console.log("true")// Set loading to true when the button is clicked
    ...
    setIsLoading(true); 
    console.log("false")// Set loading back to false after loading is complete
  };
  ...
  return (
    <div
      ...
      } duration-700 max-sm:right-0 sm:top-0 w-[30%] min-w-[350px] h-full z-50 bg-white
                           shadow-2xl p-8 px-16 overflow-y-auto overflow-x-hidden`}
    >
      ...
      {total_parent_comments > totalParentCommentsLoaded && !isLoading && (
        <button
