      ...
      return (
            ...
            <div className="flex gap-10 border-b mb-6 max-md:px-4
             border-grey pb-6 items-center">
                  ...
                  <img src={banner} className="max-md:hidden lg:hidden xl:block
                  w-28 h-28 flex-none bg-grey object-cover" />

                  <div className="flex flex-col justify-between py-2 w-full 
                  min-w-[300px]">
                        <div>
                              <Link to={`/blog/${blog_id}`} className="blog-title
                              mb-4 hover:underline" >{title}
                              </Link>
            ...
            {
                  showStat ? <div className="lg:hidden"><BlogStats stats=
                  {activity}/></div>:""
...
export const ManageDraftBlogPost =({blog})=>{
      ...
      return(
            <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6
            border-grey">
