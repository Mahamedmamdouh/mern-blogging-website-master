...
const BlogPage=()=>{
      ...
      let {title,banner,content,author:{personal_info:{fullname,
            username:author_username,profile_img}},publishedAt,tags}=blog;
            ...
            <AnimationWrapper>
                  {
                        loading ?<Loader/> 
                        :
                        <BlogContext.Provider value={{blog,setBlog,isLikedByUser,setLikedByUser,commentsWrapper,
                              ...
                              <div className="mt-12">
                                    ...
                                    <div className="flex max-sm:flex-col justify-between my-8">
                                          ...
                                          <p className="text-dark-grey opacity-75 max-sm:mt-6 max-sm-12 max-sm:pl-5">
                                                Published on {publishedAt ? getDay(publishedAt) : "Unknown Date"}
                                                </p>
