                        ...
                        <form ref={editProfileForm}>
                              ...
                              <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                                    ...
                                    <div className="max-lg:center mb-5">
                                          <label htmlFor="uploadImg" id="profileImgLabel" className="relative
                                          block w-48 h-48 bg-grey rounded-full overflow-hidden">

                                                <div className="w-full h-full absolute top-0 left-0 flex 
                                                 justify-center text-white bg-black/80 opacity-0 hover:opacity-100
                                                cursor-pointer items-center">Upload Image</div>
                              ...
                              <div className="w-full">
                                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                          <div>
                                                ...
                                                value={fullname} disable={true} icon='fi-rr-user'/>
                                          </div>
                                          <div>
                                                <InputBox name="email" type="email" placeholder="Full Name"
                                                value={email} disable={true} icon='fi-rr-envelope'/>
                                          </div>
                                    </div>
                                    <InputBox name="username" type="text" placeholder="Username"
                                       value={profile_username} icon='fi-rr-at'/>

                                       <p className="text-dark-grey -mt-3">Username will use to search user and will be visible to all users</p>

                                       <textarea name="bio" defaultValue={bio} maxLength={bioLimit} className="input-box h-64 lg:h-40 resize-none
                                        loading-7 mt-5 pl-7" placeholder="Bio" onChange={handleCharacterChange}></textarea>
                                        ...
                                        <div className="md:grid md:grid-cols-2 gap-x-6">

                                          {
                                                Object.keys(social_links).map((key,i)=>{
                                                      ...
                                                      return<InputBox key={i} name={key} value={link}
                                                      type='text'  placeholder='https://' icon={"fi " + (key!='website'?'fi-brands-' + key : "fi-rr-globe")}/>
                                                })
